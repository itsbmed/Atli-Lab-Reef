      ...
      <section class="plan-workspace">
        ...
        <article v-if="selectedItem" class="action-detail">
          ...
          <section v-if="selectedItem.dose" class="verified-dose">
            ...
            <a v-if="selectedItem.dose.productUrl" class="shop-link" :href="selectedItem.dose.productUrl" target="_blank" rel="noreferrer">{{ selectedItem.dose.productName }} im ATI Shop ansehen ↗</a>
          </section>
...
<style scoped>
.dosing-plan{display:grid;gap:22px}.plan-header{display:flex;align-items:flex-end;justify-content:space-between;gap:28px;padding:6px 2px 22px;border-bottom:1px solid var(--border)}.plan-header>div:first-child>span{color:var(--teal-700);font-size:12px;font-weight:850;letter-spacing:.1em;text-transform:uppercase}.plan-header h2{margin-top:5px;color:var(--text);font-size:32px;letter-spacing:-.03em}.plan-header p{max-width:720px;margin-top:7px;color:var(--text-muted);font-size:15px;line-height:1.5}.aquarium-context{min-width:270px;padding:15px 17px;border:1px solid var(--border);border-radius:14px;background:#f6fafc}.aquarium-context small,.aquarium-context strong,.aquarium-context span{display:block}.aquarium-context small{color:var(--teal-700);font-size:11px;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.aquarium-context strong{margin-top:4px;color:var(--text);font-size:16px}.aquarium-context span{margin-top:3px;color:var(--text-muted);font-size:13px}.blocking-note,.clean-state{display:flex;align-items:center;gap:14px;padding:20px;border-radius:15px}.blocking-note{border:1px solid #fed7aa;background:#fff7ed;color:#9a4d0a}.clean-state{min-height:160px;justify-content:center;background:#ecfdf5;color:#047857}.blocking-note>i,.clean-state>i{display:grid;place-items:center;flex:none;width:44px;height:44px;border-radius:12px;background:#f59e0b;color:#fff;font-style:normal;font-weight:900}.clean-state>i{background:#10b981}.blocking-note strong,.clean-state strong{display:block;font-size:17px}.blocking-note p,.clean-state p{margin-top:4px;font-size:14px;line-height:1.5}.plan-summary{display:grid;grid-template-columns:repeat(4,1fr);overflow:hidden;border:1px solid var(--border);border-radius:16px;background:#f8fbfe}.plan-summary>div{display:grid;grid-template-columns:1fr auto;gap:4px 10px;padding:18px 19px;border-right:1px solid var(--border)}.plan-summary>div:last-child{border:0}.plan-summary span{grid-column:1/-1;color:var(--text-muted);font-size:11px;font-weight:850;letter-spacing:.07em;text-transform:uppercase}.plan-summary strong{color:var(--text);font-size:26px}.plan-summary small{align-self:end;padding-bottom:4px;color:var(--text-muted);font-size:11px}.plan-summary .ready{background:#ecfdf5}.plan-summary .ready strong{color:#047857}.sequence-note{display:flex;align-items:center;gap:11px;padding:13px 16px;border-radius:12px;background:#eef7fd;color:#456378;font-size:13px;line-height:1.5}.sequence-note>i{display:grid;place-items:center;flex:none;width:26px;height:26px;border-radius:50%;background:var(--brand-blue);color:#fff;font-style:normal;font-weight:900}.plan-workspace{display:grid;grid-template-columns:285px minmax(0,1fr);gap:20px;align-items:start}.action-queue{position:sticky;top:calc(var(--topbar-height,68px) + 18px);display:grid;gap:7px;padding:11px;border:1px solid var(--border);border-radius:17px;background:#f4f8fb}.action-queue>header{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:7px 7px 11px}.action-queue>header span{color:var(--text-muted);font-size:11px;font-weight:850;letter-spacing:.07em;text-transform:uppercase}.action-queue>header strong{color:var(--text);font-size:12px}.queue-item{display:grid;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:10px;min-height:72px;padding:11px;border:1px solid transparent;border-radius:12px;background:transparent;color:inherit;text-align:left;cursor:pointer}.queue-item:hover{background:#fff}.queue-item.active{border-color:#afd0e5;background:#fff;box-shadow:0 5px 14px rgba(10,27,67,.07)}.queue-item>b{display:grid;place-items:center;width:36px;height:36px;border-radius:9px;background:#e6eef4;color:#60758a;font-size:12px}.queue-item.critical>b{background:#fdecea;color:#b53a2e}.queue-item span,.queue-item span>*{display:block;min-width:0}.queue-item small{color:var(--teal-700);font-size:10px;font-weight:850;text-transform:uppercase}.queue-item strong{margin-top:2px;overflow:hidden;color:var(--text);font-size:14px;text-overflow:ellipsis;white-space:nowrap}.queue-item em{margin-top:3px;color:var(--text-muted);font-size:11px;font-style:normal}.queue-item>i{color:var(--brand-blue);font-size:20px;font-style:normal}.action-detail{overflow:hidden;border:1px solid var(--border);border-radius:18px;background:#fff}.detail-header{display:grid;grid-template-columns:68px minmax(0,1fr) auto;align-items:center;gap:17px;padding:24px}.element-symbol{display:grid;place-items:center;width:66px;height:66px;border-radius:17px;background:linear-gradient(145deg,#e9f8f6,#e8f3fc);color:var(--brand-blue);font-size:19px;font-weight:900}.detail-header>div:nth-child(2)>span{color:#b53a2e;font-size:11px;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.detail-header h3{margin-top:4px;color:var(--text);font-size:24px}.detail-header p{max-width:720px;margin-top:6px;color:var(--text-muted);font-size:14px;line-height:1.55}.detail-header>em{padding:7px 11px;border-radius:999px;background:#eef5fb;color:var(--brand-blue);font-size:11px;font-style:normal;font-weight:850}.detail-header>em.water{background:#e9f8ff;color:#03698b}.detail-header>em.nutrient{background:#fff7df;color:#9a5b0a}.value-journey{display:grid;grid-template-columns:1fr minmax(100px,.55fr) 1fr 1.1fr;align-items:center;gap:12px;padding:19px 24px;border-block:1px solid var(--border);background:#f8fbfe}.value-journey>div:not(.journey-line){display:grid;grid-template-columns:1fr auto;gap:3px 6px;padding:13px 15px;border-radius:12px;background:#fff}.value-journey span{grid-column:1/-1;color:var(--text-muted);font-size:10px;font-weight:850;text-transform:uppercase}.value-journey strong{color:var(--text);font-size:22px}.value-journey small{align-self:end;color:var(--text-muted);font-size:11px}.value-journey .target{background:#ecfdf5}.value-journey .target strong{color:#047857}.journey-line{position:relative;text-align:center}.journey-line:before{position:absolute;top:50%;right:0;left:0;height:2px;background:#b8d6e8;content:""}.journey-line i{position:relative;display:block;width:12px;height:12px;margin:auto;border:3px solid #fff;border-radius:50%;background:var(--brand-blue);box-shadow:0 0 0 1px #9dc7df}.journey-line b{position:relative;display:inline-block;margin-top:10px;padding:3px 7px;border-radius:5px;background:#f8fbfe;color:var(--brand-blue);font-size:11px}.verified-dose,.dose-status,.procedure{margin:22px 24px 0}.verified-dose{overflow:hidden;border:1px solid #86efac;border-radius:15px;background:#f5fff9}.verified-dose>header{display:flex;align-items:center;justify-content:space-between;padding:15px 17px;border-bottom:1px solid #bbf7d0}.verified-dose>header span{color:#047857;font-size:11px;font-weight:850;text-transform:uppercase}.verified-dose h4{margin-top:3px;color:#064e3b;font-size:18px}.verified-dose>header>b{padding:6px 10px;border-radius:999px;background:#10b981;color:#fff;font-size:11px}.dose-metrics{display:grid;grid-template-columns:repeat(3,1fr)}.dose-metrics>div{padding:16px 17px;border-right:1px solid #bbf7d0}.dose-metrics>div:last-child{border:0}.dose-metrics span,.dose-metrics strong{display:block}.dose-metrics span{color:#047857;font-size:11px}.dose-metrics strong{margin-top:3px;color:#064e3b;font-size:20px}.verified-dose>p{padding:13px 17px;border-top:1px solid #bbf7d0;color:#047857;font-size:13px;line-height:1.5}.shop-link{display:inline-flex;align-items:center;gap:6px;margin:0 17px 15px;padding:9px 15px;border:1px solid #10b981;border-radius:999px;background:#fff;color:#047857;font-size:12px;font-weight:850;text-decoration:none;transition:background .15s,color .15s}.shop-link:hover{background:#10b981;color:#fff}.dose-status{display:grid;grid-template-columns:52px 1fr;align-items:center;gap:15px;padding:16px 17px;border:1px solid #cfe0ec;border-radius:15px;background:#f7fbfd}.dose-icon{display:grid;place-items:center;width:50px;height:50px;border-radius:13px;background:#e7f2f9;color:var(--brand-blue);font-size:13px;font-weight:900}.dose-status span,.dose-status strong{display:block}.dose-status span{color:var(--teal-700);font-size:11px;font-weight:850;text-transform:uppercase}.dose-status strong{margin-top:3px;color:var(--text);font-size:16px}.dose-status p{margin-top:4px;color:var(--text-muted);font-size:13px;line-height:1.5}.dose-status.water{border-color:#bde7f2;background:#f2fcff}.recommended-products{margin:14px 24px 0}.product-label{display:block;margin-bottom:8px;color:var(--teal-700);font-size:11px;font-weight:850;letter-spacing:.07em;text-transform:uppercase}.product-card{display:flex;align-items:center;gap:14px;padding:12px;border:1px solid var(--border);border-radius:15px;background:#fff;text-decoration:none;color:inherit;transition:border-color .15s,box-shadow .15s}.product-card:not(.inert):hover{border-color:var(--brand-blue);box-shadow:0 8px 20px rgba(10,27,67,.08)}.product-card.inert{cursor:default}.product-card img{width:52px;height:52px;object-fit:contain;border-radius:10px;background:#f4f8fb;flex-shrink:0}.product-card span{display:flex;flex-direction:column;gap:3px;font-size:14px;font-weight:800;color:var(--text)}.product-card em{font-style:normal;font-size:11px;font-weight:850;color:var(--brand-blue)}.procedure{border-top:1px solid var(--border);padding-top:20px}.procedure>header{display:flex;justify-content:space-between;gap:14px}.procedure>header span{color:var(--teal-700);font-size:12px;font-weight:850;text-transform:uppercase}.procedure>header strong{color:var(--text-muted);font-size:12px}.procedure ol{display:grid;gap:9px;margin-top:13px;padding:0;list-style:none}.procedure li{display:grid;grid-template-columns:38px 1fr;align-items:center;gap:12px;padding:13px 14px;border-radius:12px;background:#f7fafc}.procedure li>b{display:grid;place-items:center;width:36px;height:36px;border-radius:9px;background:#e3f1f9;color:var(--brand-blue);font-size:12px}.procedure li>p{color:var(--text);font-size:14px;line-height:1.55}.caution{display:grid;grid-template-columns:38px 1fr;align-items:center;gap:12px;margin:18px 24px;padding:14px 15px;border-left:4px solid #f59e0b;border-radius:11px;background:#fff8e8}.caution>i{display:grid;place-items:center;width:34px;height:34px;border-radius:9px;background:#f59e0b;color:#fff;font-style:normal;font-weight:900}.caution strong{color:#92400e;font-size:13px}.caution p{margin-top:3px;color:#9a5b0a;font-size:13px;line-height:1.5}.detail-footer{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:14px;padding:16px 24px;border-top:1px solid var(--border);background:#f7fafc}.detail-footer button{min-height:42px;padding:0 15px;border:1px solid var(--border);border-radius:10px;background:#fff;color:var(--brand-blue);font-size:12px;font-weight:850;cursor:pointer}.detail-footer button:disabled{opacity:.35;cursor:default}.detail-footer>div{text-align:center}.detail-footer span,.detail-footer strong{display:block}.detail-footer span{color:var(--text-muted);font-size:10px;text-transform:uppercase}.detail-footer strong{margin-top:3px;color:var(--text);font-size:13px}
